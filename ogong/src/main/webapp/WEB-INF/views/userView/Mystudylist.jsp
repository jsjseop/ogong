   ...
   <script src="/javascript/bootstrap-dropdownhover.min.js"></script>
	...
	$(function(){
		...
		$( "td:contains('복구')").on("click",function(){
	 	...
	 	$( "a:contains('진행중인 스터디')" ).on("click" , function() {
	 		location.href = "/admin/listTotalUser?listType=1";
		});
		
	 	$( "a:contains('신청중인 스터디')" ).on("click" , function() {
	 		location.href = "/admin/listTotalUser?listType=2";
		});
	 	
	 	$( "a:contains('종료된 스터디')" ).on("click" , function() {
...
<body>
	...
	<!-- 각 목록에 타입을 지정하여 해당하는 목록을 출력 -->
	    ...
	    <ul class="nav nav-tabs">
  			<li role="presentation"><a href="#">진행중인 스터디</a></li>
  			<li role="presentation"><a href="#">신청중인 스터디</a></li>
  			<li role="presentation"><a href="#">종료된 스터디</a></li>
		</ul>
