...
<script type="text/javascript">
	...
	function fncAddStudy() {
		$("form").attr("method","POST").attr("action","/selfStudy/addStudy?studyType="+`${studyType}`).submit();
	}
...
<body>
	<div class="container">
		...
		<div class="hashTag_area">
	        ...
	        <div class="form-group">
			  	<label for="studyHashtag" class="col-sm-offset-1 col-sm-3 control-label">해시태그</label>
	        	<div class="col-sm-4">
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
		      <button type="button" id="btn1" class="btn btn-info"  >개 &nbsp;설</button>
